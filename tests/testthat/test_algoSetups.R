...
test_that("Test aitoa.algorithm.setup", {
  ...
  r1 <- aitoa.algorithm.setup.gp("gp8_ea_1024+3024@0d05");
  r2 <- aitoa.algorithm.setup("gp8_ea_1024+3024@0d05");
  expect_identical(r1, r2);
  expect_identical(r1$algo.algorithm, "ea");
  ...
  r1 <- aitoa.algorithm.setup.gp("gp8_sa_log_10_1");
  r2 <- aitoa.algorithm.setup("gp8_sa_log_10_1");
  expect_identical(r1, r2);
  expect_identical(r1$algo.algorithm, "sa");
  expect_identical(r1$algo.representation, "tree");
  expect_identical(r1$algo.operator.unary, "tree1");
