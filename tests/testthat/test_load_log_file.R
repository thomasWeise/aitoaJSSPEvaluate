...
test_that("Test load.log.file 1", {
  file <- .make.log.file(list(c(11, 1, 33)),
                         1000,
                         180000);
  data <- load.log.file(file);
  unlink(file);
...
test_that("Test load.log.file 2", {
  file <- .make.log.file(list(c(11, 1, 33),
                              c( 9, 2, 35)),
                         1000,
                         180000);
...
test_that("Test load.log.file 3", {
  file <- .make.log.file(list(c(11, 1, 33),
                              c( 9, 2, 35),
                              c( 8, 1000, 180000)),
                         1000,
...
test_that("Test load.log.file 4", {
  file <- .make.log.file(list(c(11, 1, 33),
                              c( 9, 2, 35),
                              c( 8, 1000, 180000)),
                         1000,
...
test_that("Test load.log.file 5", {
  file <- .make.log.file(list(c(11, 1, 33),
                              c( 9, 2, 35),
                              c( 8, 1000, 180000)),
                         1002,
